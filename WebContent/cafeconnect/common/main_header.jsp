		...
		<div class=top>
			...
			<table>
					...
					<tr>
						...
						<td><a href="MobileCartView.action">モバイルカート</a></td>
						<td><a href="CartView.action">オンラインカート</a></td>
		...
		<div class=menu>
			<table>
				<tr>
					...
					<th><a href="ShopDetail.action"><img src=../img/header/店舗情報.png width="40"></a></th>
